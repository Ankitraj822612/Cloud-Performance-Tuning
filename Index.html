...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            <img class="masthead-avatar mb-5" src="assets/img/images.jpg" alt="Parking Lot">
            <h1 class="masthead-heading text-uppercase mb-0">Welcome to Our Parking System</h1>
            <div class="divider-custom divider-light">
                <div class="divider-custom-line"></div>
                <div class="divider-custom-icon"><i class="fas fa-car"></i></div>
                <div class="divider-custom-line"></div>
            </div>
            <p class="masthead-subheading">Efficient, Secure, and Convenient</p>
        </div>
    </header>
    ...
    <footer class="py-4 text-center text-white bg-dark">
        <div class="container"><small>&copy; Vehicle Parking Management System 2023</small></div>
    </footer>
